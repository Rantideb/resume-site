...
const socialLinks = [
  {
    id: 1,
    title: "Rantideb Howlader's Github Profile",
    link: "https://github.com/Rantideb",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Rantideb Howlader's LinkedIn Profile",
    link: "https://www.linkedin.com/in/rantideb/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Check Rantideb Howlader on Dev.to",
    link: "https://dev.to/rantideb",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: "Rantideb Howlader's Profile on Facebook",
    link: "https://www.facebook.com/R4ntideb",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
