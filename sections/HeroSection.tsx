    ...
    >
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="Rantideb Howlader character illustration levitating with a Macbook"
              alt="Rantideb Howlader character illustration"
            />
          </div>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p align="justify">Tech & Business Enthusiast. Love to work with Web Technologies. A self-taught web developer, who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact. I have also a passion for Content Development & Digital Media Marketing.</p>
        </div>
        <LinkButton href={`mailto:connect@ranti.dev`}>
          Contact me!
        </LinkButton>
      </div>
      <a
