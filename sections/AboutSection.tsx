...
import satNaing from "../public/ranti.png";
      ...
      <section id="whoami" className="section">
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="Rantideb Howlader profile picture"
            ...
            As a passionate new web developer, I am eager to bring my technical skills and creative flair to the world of web development. I have a strong desire to create innovative and user-friendly websites that deliver an exceptional experience for clients and users alike.
            </p>
            ...
            <div
              ...
              ref={eduRef}
            >
              <p className="edu-bg my-4">Education Background</p>
...
const educationInfo = [
  {
    id: 1,
    title: "B.A (Hons) in English Literature",
    subTitle: "Banaras Hindu University | 2020 ~ 2023",
    list: [
      "Studying History of Art, English, Travel and Tourism Management Combined along with Language Subject Bengali",
      "Apart from this, I am doing Diploma in German Language.",
    ],
  },
  {
    id: 2,
    title: "Specialisations Course in Direction & Screenplay Writing",
    subTitle: "Satyajit Ray Film & Television Institute | 2018 - 2020",
    list: [
      "Studied modules specializing in Direction & Screenplay Writing",
