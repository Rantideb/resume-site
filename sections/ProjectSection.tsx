...
import terminalPortfolio from "public/projects/blog.png";
  ...
  return (
    <section ref={sectionRef} id="projects" className="section">
      ...
      <span className="project-desc text-center block mb-4" ref={elementRef}>
        Here are some of my projects <br /></span>
...
const projects = [
  {
    ...
    desc: "Blog Website for sharing my thoughts and ideas.",
    tags: ["React", "TypeScript", "Styled-Components"],
    liveUrl: "http://hijibiji.world/index-1.html",
    codeUrl: "https://github.com/Rantideb/blogs",
    bgColor: "bg-[#B4BEE0]",
  },
  // {
  //   title: "Haru Fashion",
